...
class RadioUdaan_Admin_Pages {
	...
	public static function render_settings() {
		...
		$app_store_ov = trim( (string) get_option( RadioUdaan_App_Settings::OPTION_APP_STORE_URL, '' ) );
		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="ru-settings-form">
			...
			RadioUdaan_Admin_Settings_Page::render(
				array(
					...
					'donate_razorpay_enabled'   => RadioUdaan_App_Donations_Settings::is_razorpay_enabled(),
					...
					'donate_80g_legal_text'     => RadioUdaan_App_Donations_Settings::get_80g_legal_text(),
					'donate_80g_trust_pan'      => RadioUdaan_App_Donations_Settings::get_80g_trust_pan(),
					'donate_80g_signatory_attachment_id' => (int) get_option( RadioUdaan_App_Donations_Settings::OPTION_80G_SIGNATORY_ATTACHMENT_ID, 0 ),
					'donate_80g_signatory_url'  => RadioUdaan_App_Donations_Settings::get_80g_signatory_url(),
					...
					'azuracast_now_playing_url'  => RadioUdaan_App_Azuracast_Now_Playing::get_api_url(),
