...
|-------|------------------|-----------|---------------|-------|
| GitHub `main` | **2.0.0+54** | local | 2026-07-11 | iOS share: fullScreen host wrapper (half sheet ignored detents) |
| TestFlight iOS | **2.0.0+54** | not pushed | 2026-07-11 | Share sheet full screen on iPhone |
