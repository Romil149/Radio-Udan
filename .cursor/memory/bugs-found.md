...
| BUG-019 | 🔴 Critical | Staging WP + iOS APNs | Push inbox OK; Android banner OK; iOS no system banner | User 2026-07-10 | Registration now OK (APNs+FCM+register). Staging FCM project matches `72232`, 4 devices. **Likely Firebase APNs Auth Key missing/wrong on `72232`.** Inbox always created before FCM. |
